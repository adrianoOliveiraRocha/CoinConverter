...
function LibraEsterlina() {
  ...
  React.useEffect(() => { 
    ...
    function update() {
      setReady(false);
      let isMounted = true;
      fetch('https://economia.awesomeapi.com.br/all/GBP-BRL')
    ...
    ? (
      <View>
        <View style={styleCoins.coinContainer}>
          <Text style={styleCoins.title}>{data.GBP.code}</Text>
          <View style={styleCoins.valueInfo}>
            <Text style={styleCoins.low}>-{data.GBP.low}</Text>
            <Text style={styleCoins.height}>+{data.GBP.high}</Text>             
          </View>        
          <View style={styleCoins.valueInfo}>
            <Text style={styleCoins.normal}>Compra</Text>
            <Text style={styleCoins.normal}>{data.GBP.bid}</Text>             
          </View>   
          <View style={styleCoins.valueInfo}>
            <Text style={styleCoins.normal}>Venda</Text>
            <Text style={styleCoins.normal}>{data.GBP.varBid}</Text>             
          </View>  
          <View style={styleCoins.valueInfo}>
            <Text style={styleCoins.normal}>Variação</Text>
            <Text style={styleCoins.normal}>{data.GBP.pctChange} %</Text>             
          </View>   
          <Text>Atualizado em {data.GBP.create_date.toLocaleString("pt-BR")}</Text>    
        </View>  
      </View>
    )
    : (
